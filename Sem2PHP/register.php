...
if($username==null){
    ...
    $userNameQuery = $mysqli->query("SELECT username FROM userold WHERE username = '$usernameQ' ");
    ...
    if (null != $userNameQuery->fetch_object()){
        ...
        if($password==$repeatPassword){
            $mysqli->query("INSERT INTO userold (username, password) VALUES('$usernameQ', '$passwordQ') ");
